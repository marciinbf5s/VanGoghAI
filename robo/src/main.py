...
STOP_LOSS_PERCENTAGE        = 2.5         # (Em base 100%) % Máxima de loss que ele aceita para vender à mercado independente.
...
TRAILING_STOP_PERCENTAGE = 2    # (Em base 100%) % de trailing stop que o bot irá usar (não use 0 nem valores negativos).
...
EXECUTE_MARKET_ORDERS = True  # (Stop Loss sempre será executado à mercado, independente deste parâmetro).
